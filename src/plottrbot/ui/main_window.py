...
class MainWindow(QMainWindow):
    ...
    def _build_image_prep_tab(self) -> None:
        ...
        self.slider_prep_exposure.setRange(-100, 300)
        self.slider_prep_exposure.setValue(0)
        self.lbl_prep_exposure_value = QLabel("0")
        self.lbl_prep_exposure_value.setMinimumWidth(48)
        ...
        self.prep_mask_settings_panel = QWidget()
        mask_settings_layout = QGridLayout(self.prep_mask_settings_panel)
        ...
        self.slider_prep_mask_rotation = QSlider(Qt.Orientation.Horizontal)
        self.slider_prep_mask_rotation.setRange(-180, 180)
        self.lbl_prep_mask_rotation_value = QLabel("0 deg")
        self.lbl_prep_mask_rotation_value.setMinimumWidth(52)
        self.lbl_prep_mask_rotation_value.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        mask_settings_layout.addWidget(QLabel("Rotation"), 3, 0)
        mask_rotation_row = QHBoxLayout()
        mask_rotation_row.setContentsMargins(0, 0, 0, 0)
        mask_rotation_row.addWidget(self.slider_prep_mask_rotation, 1)
        mask_rotation_row.addWidget(self.lbl_prep_mask_rotation_value)
        mask_settings_layout.addLayout(mask_rotation_row, 3, 1)
        ...
        mask_settings_layout.addWidget(QLabel("Feather"), 4, 0)
        ...
        mask_settings_layout.addLayout(mask_feather_row, 4, 1)
        ...
        mask_settings_layout.addWidget(QLabel("Local exposure"), 5, 0)
        ...
        mask_settings_layout.addLayout(mask_exposure_row, 5, 1)
        ...
        mask_settings_layout.addWidget(QLabel("Local contrast"), 6, 0)
        ...
        mask_settings_layout.addLayout(mask_contrast_row, 6, 1)
        ...
        mask_settings_layout.addWidget(QLabel("Local blur"), 7, 0)
        ...
        mask_settings_layout.addLayout(mask_blur_row, 7, 1)
    ...
    def _connect_signals(self) -> None:
        ...
        self.slider_prep_exposure.valueChanged.connect(self._on_prep_exposure_slider_changed)
        ...
        self.slider_prep_mask_rotation.valueChanged.connect(self._on_prep_mask_controls_changed)
    ...
    def _sync_prep_controls_from_state(self) -> None:
        ...
        self.slider_prep_exposure.setValue(settings.exposure_percent)
        self._update_signed_value_label(self.lbl_prep_exposure_value, settings.exposure_percent)
    ...
    def _read_prep_settings_from_controls(self) -> ImagePrepSettings:
        ...
        settings = ImagePrepSettings(
            ...
            exposure_percent=self.slider_prep_exposure.value(),
    ...
    def _sync_prep_mask_controls_from_state(self) -> None:
        ...
        self.prep_mask_settings_panel.setVisible(selected is not None)
        if selected is None:
            ...
            self.slider_prep_mask_rotation.setValue(0)
            ...
            self.slider_prep_mask_rotation.setValue(int(round(selected.rotation_degrees)))
            ...
            self.slider_prep_mask_blur.setValue(int(round(selected.blur_radius * 10.0)))
        self._update_prep_mask_value_labels()
        self._prep_mask_controls_syncing = False

    def _update_signed_value_label(self, label: QLabel, value: int) -> None:
    ...
    def _update_prep_mask_value_labels(self) -> None:
        ...
        self.lbl_prep_mask_rotation_value.setText(f"{self.slider_prep_mask_rotation.value()} deg")
        ...
        self._update_signed_value_label(
            ...
            self.slider_prep_mask_exposure.value(),
        )
        self._update_signed_value_label(
            self.lbl_prep_mask_contrast_value,
            self.slider_prep_mask_contrast.value(),
        )
        self.lbl_prep_mask_blur_value.setText(f"{self.slider_prep_mask_blur.value() / 10.0:.1f}")
    ...
    def _on_prep_exposure_slider_changed(self, value: int) -> None:
        self._update_signed_value_label(self.lbl_prep_exposure_value, int(value))
        if self._prep_updating_controls or self._prep_slider_syncing:
            return
    ...
    def _on_prep_mask_controls_changed(self, *_args: object) -> None:
        ...
        masks[self._selected_prep_mask_index] = replace(
            ...
            rotation_degrees=float(self.slider_prep_mask_rotation.value()),
            ...
            blur_radius=float(self.slider_prep_mask_blur.value()) / 10.0,
        ).sanitized()
        self.image_prep_state.settings.local_masks = masks
    ...
    def _update_ui_state(self) -> None:
        ...
        self.slider_prep_mask_rotation.setEnabled(prep_has_selected_mask and prep_controls_enabled)
        ...
        self.slider_prep_mask_blur.setEnabled(prep_has_selected_mask and prep_controls_enabled)
        ...
        self.slider_prep_exposure.setEnabled(prep_has_source and prep_controls_enabled)
